...
public class AccountService implements IAccountService {
    ...
    public void deposit(int userId,double amount){
        ...
        if (optionalAccount.isPresent()) {
            ...
            updateAccount.setBalance((updateAccount.getBalance() + amount)/ usdValue);
        ...
        if (senderAccount.isPresent()) {
            ...
            if (receiverAccount.isPresent()) {
                ...
                if (updateSenderAccount.getBalance() >= amount) {
                    ...
                    updateSenderAccount.setBalance((updateSenderAccount.getBalance() - amount)/ usdValue);
                    updateReceiverAccount.setBalance(updateReceiverAccount.getBalance() + amount);
                    updateReceiverAccount.setBalance((updateReceiverAccount.getBalance() + amount)/ usdValue);
                ...
                if (updateSenderAccount.getBalance() >= newBalance) {
                    ...
                    updateSenderAccount.setBalance(updateSenderAccount.getBalance() / usdValue);
